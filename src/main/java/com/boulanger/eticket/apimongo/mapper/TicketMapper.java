...
public class TicketMapper {
	...
	public Ticket storedTicketToTicket(StoredTicket storedTicket, String lang) {
		return Ticket.builder()
				...
				.customer(Ticket.Customer.builder()
						...
						.name(storedTicket.getCustomer().getLastName())
	...
	public StoredTicket ticketToStoredTicket(Ticket ticket) {
		...
		return StoredTicket.builder()
				...
				.customer(StoredTicket.Customer.builder()
						...
						.lastName(ticket.getCustomer().getName())
	...
	public StoredTicket ticketToStoreToStoredTicket(TicketToStore ticketToStore) {
		...
		return StoredTicket.builder()
				...
				.customer(StoredTicket.Customer.builder()
						...
						.lastName(ticketToStore.getCustomer().getName())
	...
	public Ticket withdrawalToTicket(WithdrawalTicket withdrawalTicket, String lang) {
		return Ticket.builder()
				...
				.lineTickets((Ticket.LineTicket) Ticket.LineTicket.builder()
						.line(withdrawalTicket.getWithdrawalLine().getLineId())
						.productSapId(withdrawalTicket.getWithdrawalLine().getProductSapId())
						.quantity(withdrawalTicket.getWithdrawalLine().getQuantity())
						.build())
	...
	public WithdrawalTicket ticketToWithdrawal(Ticket ticket) {
		return WithdrawalTicket.builder()
				...
				.withdrawalLine((WithdrawalTicket.WithdrawalLine) WithdrawalTicket.WithdrawalLine.builder()
	...
	public StoredTicket withdrawalToStoredTicket(WithdrawalTicket withdrawalTicket, WithdrawalTicket.WithdrawalLine withdrawalLine) {
		return StoredTicket.builder()
				...
				.id(withdrawalTicket.getSaleId()+"-"+ withdrawalLine.getLineId()+"-W")
				.customer(StoredTicket.Customer.builder()
						.identification(withdrawalTicket.getCustomerId())
						.lastName(withdrawalTicket.getCustomerName())
